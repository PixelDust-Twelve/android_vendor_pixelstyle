...
package com.pixeldust.android.systemui.statusbar.phone;
...
public class StatusBarPixeldust extends StatusBar {
    ...
    private final BatteryController.BatteryStateChangeCallback mBatteryStateChangeCallback = new BatteryController.BatteryStateChangeCallback() {
        ...
        public void onBatteryLevelChanged(int i, boolean z, boolean z2) {
            ...
            if (DEBUG) {
                Log.d("StatusBarPixeldust", "onBatteryLevelChanged(): level=" + i + ",wlc=" + (mBatteryController.isWirelessCharging() ? 1 : 0) + ",wlcs=" + mChargingAnimShown + ",rtxs=" + mReverseChargingAnimShown + ",this=" + this);
            }
        }
        ...
        public void onReverseChanged(boolean z, int i, String str) {
            ...
            if (DEBUG) {
                Log.d("StatusBarPixeldust", "onReverseChanged(): rtx=" + (z ? 1 : 0) + ",rxlevel=" + mReceivingBatteryLevel + ",level=" + i + ",name=" + str + ",wlc=" + (mBatteryController.isWirelessCharging() ? 1 : 0) + ",wlcs=" + mChargingAnimShown + ",rtxs=" + mReverseChargingAnimShown + ",this=" + this);
            }
        }
    };

    public StatusBarPixeldust(Context context,
    ...
    public void showWirelessChargingAnimation(int i) {
        if (DEBUG) {
            Log.d("StatusBarPixeldust", "showWirelessChargingAnimation()");
        }
