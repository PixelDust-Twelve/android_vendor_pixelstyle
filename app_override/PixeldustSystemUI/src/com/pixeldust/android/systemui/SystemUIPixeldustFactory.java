...
import com.pixeldust.android.systemui.dagger.DaggerSysUIPixeldustGlobalRootComponent;
import com.pixeldust.android.systemui.dagger.SysUIPixeldustSysUIComponent;
...
public class SystemUIPixeldustFactory extends SystemUIFactory {
    ...
    protected GlobalRootComponent buildGlobalRootComponent(Context context) {
        return DaggerSysUIPixeldustGlobalRootComponent.builder()
                .context(context)
                .build();
    }
    ...
    public void init(Context context, boolean fromTest) throws ExecutionException, InterruptedException {
        ...
        if (shouldInitializeComponents()) {
            ((SysUIPixeldustSysUIComponent) getSysUIComponent()).createKeyguardSmartspaceController();
        }
    }
}
