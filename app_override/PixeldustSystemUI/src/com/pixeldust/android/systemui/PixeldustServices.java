...
public class PixeldustServices extends VendorServices {
    ...
    @Inject
    public PixeldustServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService, AlarmManager alarmManager, StatusBar statusBar) {
        super(context);
